  ...
  return (
    <section className="screen active" data-key="contact">
      ...
      <div className="fields">
        ...
        <div><label htmlFor="phone">Phone</label><input id="phone" name="phone" type="tel" autoComplete="tel" required value={contact.phone || ""} onChange={handleChange} placeholder="+91 9876543210" /></div>
      </div>
    </section>
  );
}